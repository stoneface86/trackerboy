#include "units/TestPatternClip.hpp"

constexpr auto PATTERN_SIZE = 8;


TestPatternClip::TestPatternClip(QObject *parent) :
    QObject(parent),
...
void TestPatternClip::defaultConstructor() {
...
void TestPatternClip::overwritePaste() {
...
void TestPatternClip::persistance() {
...
TestPatternClip::PatternCopy::PatternCopy(trackerboy::Track const& tr1, trackerboy::Track const& tr2, trackerboy::Track const& tr3, trackerboy::Track const& tr4) :
    mTracks{tr1, tr2, tr3, tr4}
{
}

trackerboy::Pattern TestPatternClip::PatternCopy::pattern() {
    return {mTracks[0], mTracks[1], mTracks[2], mTracks[3]};
}

trackerboy::Track& TestPatternClip::PatternCopy::operator[](size_t i) {
    return mTracks[i];
}


trackerboy::Pattern TestPatternClip::emptyPattern() {
    return { mEmptyTrack, mEmptyTrack, mEmptyTrack, mEmptyTrack };
}

trackerboy::Pattern TestPatternClip::samplePattern() {
